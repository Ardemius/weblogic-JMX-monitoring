...
I just want to present the way it can be used to manipulate MBeans.
...
To manage MBeans, you need to connect to WLST *online* (equivalent to the _WebLogic Server Administration Console_)

TO BE COMPLETED (connect, ls, getMean, getPath, find)
